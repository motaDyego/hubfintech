...
class ContaControllerTest < ActionController::TestCase
  ...
  test "should create contum" do
    assert_difference('Contum.count') do
      post :create, contum: { data_criacao: @contum.data_criacao, nome: @contum.nome, status: @contum.status }
    end
  ...
  test "should update contum" do
    patch :update, id: @contum, contum: { data_criacao: @contum.data_criacao, nome: @contum.nome, status: @contum.status }
    assert_redirected_to contum_path(assigns(:contum))
  end
